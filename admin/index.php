...
$redirectUri = 'http://localhost/newsportal/admin/';
...
if (isset($_GET['code'])) {
  ...
  $name =  $google_account_info->name;
   // You can create or update user record here
   $_SESSION['login'] = $email; // Use email as username
   $_SESSION['utype'] = 'google_user';
                                ...
                                <div class="text-center account-logo-box">
                                    <h2 class="text-uppercase">
                                        <a href="index.html" class="text-success">
                                            <span><img src="assets/images/news.jpeg" alt="" height="70px" width="200px"></span>
                                        </a>
                                    </h2>
...
<a href="../index.php"><i class="mdi mdi-home"></i> Back Home</a>
                                ...
                                <center><a href="<?php  echo $client->createAuthUrl() ?>"><img src="assets/images/googlesignin.png" width="256px"></a></center> 
                                <hr>
